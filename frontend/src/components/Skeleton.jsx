  ...
  return (
    <div style={{
      ...
      <div style={{ padding: 24, display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        <div style={{ height: 8, width: "60%", background: "var(--border)", borderRadius: 4, opacity: 0.3 }} />
        <div style={{ marginTop: 16, height: height * 0.5, background: "var(--border)", borderRadius: 8, opacity: 0.2 }} />
      </div>
    </div>
  )
}
